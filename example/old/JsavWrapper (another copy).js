...
var VisualizedLinkedList = new function (){
    ...
    this.setHeadPointer = function (listOfVariableNames) {
        ...
        var index2 = this.size() - 1 - this.getListItemIndexByReference(this.linkedListReferences[index]);
        //window.alert(this.linkedList.get(0).value());
        window.alert(this.getListItemIndexByReference(this.linkedListReferences[index]));
        this.head = this.av.pointer(listOfVariableNames[index].variable, this.linkedList.get(0));
    ...
    this.setTailPointer = function (listOfVariableNames) {
        ...
        var index2 = this.size() - 1 - this.getListItemIndexByReference(this.linkedListReferences[index]);
        this.tail = this.av.pointer(listOfVariableNames[index].variable, this.linkedList.get(2));
    }
...
function visualize(testvisualizerTrace) {
    ...
    for(i =0, maxi = visualizationTrace.length; i<maxi; i+=1) {
        ...
        /*window.alert(VisualizedLinkedList.linkedListReferences.toSource());
        window.alert(listOfVariableNames.toSource());
        window.alert(VisualizedLinkedList.linkedListItems.toSource());
        */
        VisualizedLinkedList.createLinkedList();
        //removed.push(linkedList);
        //linkedList.layout();
        VisualizedLinkedList.layout();
        VisualizedLinkedList.setHeadPointer(listOfVariableNames);
        VisualizedLinkedList.setTailPointer(listOfVariableNames);
